...
Route::middleware([
    ...
    Route::get('/Apprentissage', [EducationController::class, 'showAllBlogsForAllUsers'])->name('AllBlogs');
...
Route::middleware([
    ...
    Route::delete('admin/destroy/{id}', [PostController::class, 'destroyPost'])->name('Posts.destroyPost');
