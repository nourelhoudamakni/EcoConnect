...
<body class="color-theme-blue mont-font">
    ...
    <div class="main-wrapper">
        ...
        <div class="nav-header bg-white shadow-xs border-0">
            ...
            <a href="default-group.html" class="p-2 text-center ms-0 menu-icon center-menu-icon"><i class="feather-user font-lg alert-primary btn-round-lg theme-dark-bg text-current "></i></a>
            ...
            <div class="dropdown-menu dropdown-menu-end p-4 rounded-3 border-0 shadow-lg" aria-labelledby="dropdownMenu3">
                ...
                <div class="card bg-transparent-card w-100 border-0 ps-5 mb-3">
                    <img src="{{ Vite::asset('resources/assetsFront/images/user-8.png') }}" alt="user" class="w40 position-absolute left-0">
                ...
                <div class="card bg-transparent-card w-100 border-0 ps-5 mb-3">
                    <img src="{{ Vite::asset('resources/assetsFront/images/user-4.png') }}" alt="user" class="w40 position-absolute left-0">
                ...
                <div class="card bg-transparent-card w-100 border-0 ps-5 mb-3">
                    <img src="{{ Vite::asset('resources/assetsFront/images/user-7.png') }}" alt="user" class="w40 position-absolute left-0">
                ...
                <div class="card bg-transparent-card w-100 border-0 ps-5">
                    <img  src="{{ Vite::asset('resources/assetsFront/images/user-6.png') }}" alt="user" class="w40 position-absolute left-0">
            ...
            <a href="default-settings.html" class="p-0 ms-3 menu-icon"><img src="{{ Vite::asset('resources/assetsFront/images/profile-4.png') }}" alt="user" class="w40 mt--1"></a>
                            ...
                            <div class="row ps-2 pe-1">
                                ...
                                <div class="col-md-6 col-sm-6 pe-2 ps-2">
                                    <div class="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3">
                                        <div class="card-body position-relative h100 bg-image-cover bg-image-center" style="background-image: url('{{ asset('resources/assetsFront/images/bb-16.png') }}');"></div>                                        <div class="card-body d-block w-100 pl-10 pe-4 pb-4 pt-0 text-left position-relative">
                                            <figure class="avatar position-absolute w75 z-index-1" style="top:-40px; left: 15px;"><img  src="{{ Vite::asset('resources/assetsFront/images/user-12.png') }}" alt="image" class="float-right p-1 bg-white rounded-circle w-100"></figure>
                                ...
                                <div class="col-md-6 col-sm-6 pe-2 ps-2">
                                    <div class="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3">
                                        <div class="card-body position-relative h100 bg-image-cover bg-image-center" style="background-image: url('{{ asset('resources/assetsFront/images/e-4.jpg') }}');"></div>
                                        <div class="card-body d-block w-100 pl-10 pe-4 pb-4 pt-0 text-left position-relative">
                                            <figure class="avatar position-absolute w75 z-index-1" style="top:-40px; left: 15px;"><img  src="{{ Vite::asset('resources/assetsFront/images/user-1.png') }}" alt="image" class="float-right p-1 bg-white rounded-circle w-100"></figure>
                                            <div class="clearfix"></div>
                                ...
                                <div class="col-md-6 col-sm-6 pe-2 ps-2">
                                    <div class="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3">
                                        <div class="card-body position-relative h100 bg-image-cover bg-image-center" style="background-image: url('{{ asset('resources/assetsFront/images/bb-9.jpg') }}');"></div>
                                        <div class="card-body d-block w-100 pl-10 pe-4 pb-4 pt-0 text-left position-relative">
                                            <figure class="avatar position-absolute w75 z-index-1" style="top:-40px; left: 15px;"><img src="{{ Vite::asset('resources/assetsFront/images/user-8.png') }}" alt="image" class="float-right p-1 bg-white rounded-circle w-100"></figure>
                                            <div class="clearfix"></div>
                                ...
                                <div class="col-md-6 col-sm-6 pe-2 ps-2">
                                    <div class="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3">
                                        <div class="card-body position-relative h100 bg-image-cover bg-image-center" style="background-image: url('{{ asset('resources/assetsFront/images/e-3.jpg') }}');"></div>
                                        <div class="card-body d-block w-100 pl-10 pe-4 pb-4 pt-0 text-left position-relative">
                                            <figure class="avatar position-absolute w75 z-index-1" style="top:-40px; left: 15px;"><img src="{{ Vite::asset('resources/assetsFront/images/user-2.png') }}" alt="image" class="float-right p-1 bg-white rounded-circle w-100"></figure>
                                            <div class="clearfix"></div>
                                ...
                                <div class="col-md-6 col-sm-6 pe-2 ps-2">
                                    <div class="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3">
                                        <div class="card-body position-relative h100 bg-image-cover bg-image-center" style="background-image: url('{{ asset('resources/assetsFront/images/e-1.jpg') }}');"></div>
                                        <div class="card-body d-block w-100 pl-10 pe-4 pb-4 pt-0 text-left position-relative">
                                            <figure class="avatar position-absolute w75 z-index-1" style="top:-40px; left: 15px;"><img  src="{{ Vite::asset('resources/assetsFront/images/user-2.png') }}" alt="image" class="float-right p-1 bg-white rounded-circle w-100"></figure>
                                            <div class="clearfix"></div>
                                ...
                                <div class="col-md-6 col-sm-6 pe-2 ps-2">
                                    <div class="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3">
                                        <div class="card-body position-relative h100 bg-image-cover bg-image-center" style="background-image: url({{ asset('resources/assetsFront/images/e-2.jpg') }});"></div>
                                        <div class="card-body d-block w-100 pl-10 pe-4 pb-4 pt-0 text-left position-relative">
                                            <figure class="avatar position-absolute w75 z-index-1" style="top:-40px; left: 15px;"><img src="{{ Vite::asset('resources/assetsFront/images/user-5.png') }}" alt="image" class="float-right p-1 bg-white rounded-circle w-100"></figure>
                                            <div class="clearfix"></div>
        ...
        <div class="app-footer border-0 shadow-lg bg-primary-gradiant">
            ...
            <a href="default-settings.html" class="nav-content-bttn"><img  src="{{ Vite::asset('resources/assetsFront/images/female-profile.png') }}" alt="user" class="w30 shadow-xss"></a>
        </div>
            ...
            <div class="modal-popup-header w-100 border-bottom">
                <div class="card p-3 d-block border-0 d-block">
                    <figure class="avatar mb-0 float-left me-2">
                        <img  src="{{ Vite::asset('resources/assetsFront/images/user-12.png') }}" alt="image" class="w35 me-1">
                    </figure>
