                        ...
                        <div class="col-xl-12 col-xxl-12 col-lg-12">
                            <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                                ...
                                <div class="card-body p-lg-5 p-4 w-100 border-0 ">
                                    ...
                                    <form action="{{ route('contenu.update',$education->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="categorie" class="form-select form-control" style="line-height:20px;">
                                                    @foreach(App\Enums\CategorieEducationEnum::valuesCategories() as $key=>$value)
                                                        <option value="{{ $key }}" {{ $education->categorie === $key ? 'selected' : '' }}>
                                                            {{ $key }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="titre" value="{{ $education->titre }}">
                                                    @if ($errors->has('titre'))
                                                        <span
                                            ...
                                            <div class="col-lg-12 mb-3">
                                                <div class="form-group">
                                                    <label class="mont-font fw-600 font-xsss">Image de la couverture</label>
                                                     ...
                                                     <img src="/upload/{{ $education->image }}" width="300px" class="mt-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control " name="description" id="file-picker" >{!! $education->description !!}</textarea>
