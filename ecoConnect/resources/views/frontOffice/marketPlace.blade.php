                                        ...
                                        <div class="banner-slider owl-carousel owl-theme dot-style2 owl-nav-link link-style3 overflow-hidden">
                                            ...
                                            <div class="card bg-dark text-white " style="height:250px">
                                                ...
                                                <div class="card-img-overlay text-center" >
                                                    <h2 class="fw-700 display2-size display2-md-size lh-2 text-grey-900 mt-5 " style="color: white">Market Place</h2>
                                                    <div class="mt-3">
                                                        <a href="#" class="fw-700 text-grey-900 rounded-xl active bg-white font-xsssss text-uppercase ls-3 lh-30 mt-0 text-center d-inline-block p-2 w150 ">Shop Now</a>
                                                        <a href="#" class="fw-700 text-grey-900 rounded-xl bg-white font-xsssss text-uppercase ls-3 lh-30 mt-0 text-center d-inline-block p-2 w150 mt-2 mt-lg-0">Shop Now</a>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="modal-body p-0">
                    <div class="card w-100 border-0 rounded-3 overflow-hidden bg-gradiant-bottom bg-gradiant-top">
                        <div class="owl-carousel owl-theme dot-style3 story-slider owl-dot-nav nav-none">
                            <div class="item"><img  src="{{ Vite::asset('resources/assetsFront/images/story-5.jpg') }}"alt="image"></div>
                            <div class="item"><img  src="{{ Vite::asset('resources/assetsFront/images/story-6.jpg') }}"alt="image"></div>
                            <div class="item"><img  src="{{ Vite::asset('resources/assetsFront/images/story-7.jpg') }}"alt="image"></div>
                            <div class="item"><img  src="{{ Vite::asset('resources/assetsFront/images/story-8.jpg') }}"alt="image"></div>
