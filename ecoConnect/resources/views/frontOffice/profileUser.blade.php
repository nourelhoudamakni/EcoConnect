...
<body class="color-theme-blue mont-font">
    ...
    <div class="main-wrapper">
        ...
        <div class="nav-header bg-white shadow-xs border-0">
            ...
            <a href="#" class="p-2 text-center ms-auto menu-icon" id="dropdownMenu3" data-toggle="dropdown"
                        ...
                        <div class="col-lg-12">
                            <div class="card w-100 border-0 p-0 bg-white shadow-xss rounded-xxl">
                                <div class="card-body h250 p-0 rounded-xxl overflow-hidden m-3"><img
                                        src="{{ Vite::asset('resources/assetsFront/images/u-bg.jpg') }}"
                                        alt="image"></div>
                        ...
                        <div class="col-xl-4 col-xxl-3 col-lg-4 pe-0">
                            ...
                            <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                                ...
                                <div class="card-body d-block pt-0 pb-2">
                                    <div class="row">
                                        <div class="col-6 mb-2 pe-1"><a href="images/e-2.jpg"
                                        ...
                                        <div class="col-6 mb-2 ps-1"><a href="images/e-3.jpg"
                                                data-lightbox="roadtrip"><img
                                                    src="{{ Vite::asset('resources/assetsFront/images/e-3.jpg') }}"
                                                    alt="image" class="img-fluid rounded-3 w-100"></a></div>
                                        <div class="col-6 mb-2 pe-1"><a href="images/e-4.jpg"
                                                data-lightbox="roadtrip"><img
                                                    src="{{ Vite::asset('resources/assetsFront/images/e-4.jpg') }}"
                                                    alt="image" class="img-fluid rounded-3 w-100"></a></div>
                                        <div class="col-6 mb-2 ps-1"><a href="images/e-5.jpg"
                                                data-lightbox="roadtrip"><img
                                        ...
                                        <div class="col-6 mb-2 pe-1"><a href="images/e-2.jpg"
                                                data-lightbox="roadtrip"><img
                                                    src="{{ Vite::asset('resources/assetsFront/images/e-2.jpg') }}"
                                                    alt="image" class="img-fluid rounded-3 w-100"></a></div>
                                        <div class="col-6 mb-2 ps-1"><a href="images/e-1.jpg"
                                                data-lightbox="roadtrip"><img
                            ...
                            <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                                <div class="card-body p-0 d-flex">
                                    <figure class="avatar me-3"><img
                                            src="{{ Vite::asset('resources/assetsFront/images/user-7.png') }}"alt="image"
                                ...
                                <div class="card-body p-0 me-lg-5">
                                    <p class="fw-500 text-grey-500 lh-26 font-xssss w-100">Lorem ipsum dolor sit amet,
                                        consectetur adipiscing elit. Morbi nulla dolor, ornare at commodo non, feugiat
                                        non nisi. Phasellus faucibus mollis pharetra. Proin blandit ac massa sed rhoncus
                                        <a href="#" class="fw-600 text-primary ms-2">See more</a></p>
                                </div>
                                    ...
                                    <div class="row ps-2 pe-2">
                                        ...
                                        <div class="col-xs-4 col-sm-4 p-1"><a href="images/t-24.jpg"
                                                data-lightbox="roadtri"><img
                                                    ...
                                                    class="rounded-3 w-100" alt="image"></a></div>
                                        <div class="col-xs-4 col-sm-4 p-1"><a href="images/t-25.jpg"
                                                data-lightbox="roadtri" class="position-relative d-block"><img
                                                    src="{{ Vite::asset('resources/assetsFront/images/t-25.jpg') }}"
                                                    class="rounded-3 w-100" alt="image"><span
                                                    class="img-count font-sm text-white ls-3 fw-600"><b>+2</b></span></a>
                                        </div>
                                    </div>
        ...
        <div class="modal bottom side fade" id="Modalstries" tabindex="-1" role="dialog"
            style=" overflow-y: auto;">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content border-0 bg-transparent">
                    <button type="button" class="close mt-0 position-absolute top--30 right--10"
                        data-dismiss="modal" aria-label="Close"><i
                            class="ti-close text-white font-xssss"></i></button>
                        ...
                        <div class="card w-100 border-0 rounded-3 overflow-hidden bg-gradiant-bottom bg-gradiant-top">
                            <div class="owl-carousel owl-theme dot-style3 story-slider owl-dot-nav nav-none">
                                <div class="item"><img
                                        ...
                                        alt="image"></div>
                                <div class="item"><img
                                        src="{{ Vite::asset('resources/assetsFront/images/story-6.jpg') }}"
                                        alt="image"></div>
                                <div class="item"><img
                                        src="{{ Vite::asset('resources/assetsFront/images/story-7.jpg') }}"
                                        alt="image"></div>
                                <div class="item"><img
