                            ...
                            <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-0">
                                ...
                                <div class="card-body d-flex p-0">
                                    ...
                                    <a href="#"
                                        ...
                                        <a href="#"
                                        class=" mx-2 d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss"><i
                                            class="feather-eye text-dark text-grey-900 btn-round-sm font-lg"></i></a>
                                        <a href="{{ route('Posts.edit', ['id' => $post->id]) }}
                                        class="d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss"><i
                                            class="feather-edit text-dark text-grey-900 btn-round-sm font-lg"></i></a>
