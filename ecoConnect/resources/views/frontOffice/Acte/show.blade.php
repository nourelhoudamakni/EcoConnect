                                ...
                                @foreach($actes as $acte)
                                    <div class="col-lg-4 col-md-6 mt-3">
                                        <div class="card d-block w-100 border-0 mb-3 shadow-xss bg-white rounded-3 p-4" style="padding-left: 120px !important;">
                                            <img src="public/images/{{ $acte->image }}" width="100px" alt="Projet Image">
                                            <h4 class="font-xss fw-700 text-grey-900 mb-3 pe-4">{{ $acte->titre }}</h4>
                                            <h5 class="font-xssss mb-2 text-grey-500 fw-600">
                                                <span class="text-grey-900 font-xssss">Categorie : </span> {{ $acte->categorie }}
                                            </h5>
                                            <h5 class="font-xssss mb-2 text-grey-500 fw-600">
                                                <span class="text-grey-900 font-xssss">Description : </span> {{ $acte->description }}
                                            </h5>
                                            ...
                                            <div class="flex flex-row">
                                                <a href="{{ route('Acte.edit', ['acteVolontaire' => $acte->id]) }}" class="btn btn-primary btn-icon"><i class="feather-edit-2 font-md text-white"></i></a>
